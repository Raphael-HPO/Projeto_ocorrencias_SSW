...
- [ ] Capturar o Valor da ocorrência e qual é o cliente ao realizar a criação;
    - [ ] Criar uma validação de ocorrência de acordo com o valor da produto;
...
### Ocorrências
* 77 **(falta)**(Bloqueio de acordo com o valor);
